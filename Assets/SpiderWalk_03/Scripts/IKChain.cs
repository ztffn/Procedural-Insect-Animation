...
public class IKChain : MonoBehaviour {
    ...
    public float miniVariable = 0.00001f;
    [Header("Solving")]
    ...
    public float getTolerance() {
        return transform.lossyScale.y * miniVariable * tolerance;
    }

    public float getMinimumChangePerIterationOfSolving() {
        return transform.lossyScale.y *miniVariable * minChangePerIteration;
    }

    public float getSingularityRadius() {
        return transform.lossyScale.y * miniVariable * singularityRadius;
    }
