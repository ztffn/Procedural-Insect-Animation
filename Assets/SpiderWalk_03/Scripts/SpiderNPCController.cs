...
namespace philippschofield
{
    ...
    public class SpiderNPCController : MonoBehaviour
    {
        ...
        [Header("Spider Reference")] public Spider spider;
        ...
        private void FixedUpdate()
        {
            ...
            if (showDebug)
                Debug.DrawLine(spider.transform.position, spider.transform.position + input * 0.1f * spider.getScale(),
        ...
        private void Update()
        {
            if (showDebug)
            {
                Debug.DrawLine(spider.transform.position, spider.transform.position + X * 0.1f * spider.getScale(),
                    Color.red);
                Debug.DrawLine(spider.transform.position, spider.transform.position + Z * 0.1f * spider.getScale(),
                    Color.blue);
            }
        }
